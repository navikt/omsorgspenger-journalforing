...
internal class SafGateway(
    ...
    private suspend fun String.hentDataFraSaf(correlationId: CorrelationId): JSONObject {
        val (httpStatusCode, response) = GraphQlUrl.toString().httpPost { builder ->
    ...
    internal companion object {
        ...
        internal fun Map<JournalpostId, Set<JournalpostId>>.førsteJournalpostIdSomHarOriginalJournalpostId(
